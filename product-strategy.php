	...
	<div class="inner-body">
		...
		<main aria-label="Main content" id="main">
			<div class="main-content" role="main">
				...
				<section class="page-section">
					...
					<div class="section-content">
						...
						<div class="callout-warning">
							<strong>A note of caution:</strong> I've seen these frameworks be disruptive and cause the complete opposite of what they're designed to do. If you implement something like this, ensure it's a collaborative approach and not a top-down mandate.
						</div>
				...
				<section class="page-section">
					<div class="section-header">
						<h2 class="section-title">Working Templates</h2>
					</div>
					<div class="section-content">
						<p>These templates help squads break down a product strategy into meaningful impact. They can be used as part of an overarching product review process.</p>
