...
<head>
    ...
    <link rel="prev" title="Vibe Coding for Product Teams" href="https://mike-p.co.uk/product-team-AI-vibe-coding">
</head>
<body>
				...
				<section class="page-section">
					...
					<div class="section-content">
						...
						<div class="services-list">
							...
							<div class="service-item">
								<h3>Drive High-Impact Execution</h3>
							...
							<div class="service-item">
								<h3>Lead and Mentor Your Product Team</h3>
							...
							<div class="service-item">
								<h3>Navigate Complex Technical Challenges</h3>
