...
<<<<<<< HEAD
	<title>Home | Mike Smith | Lead Digital Business Analyst in London</title>
=======
	<title>Home | Mike Smith | Agile Lead Business Analyst in London</title>
>>>>>>> origin/master
</head>
<body>
	<div class="inner-body">
		...
		<div class="main-content" role="main">
			<h4>Who?</h4>
<<<<<<< HEAD
			<p>My name is Mike Smith and I am an experienced e-commerce <strong>lead digital business analyst</strong> working at <a href="http://which.co.uk" rel="nofollow">Which?</a>.  	
=======
			<p>My name is Mike Smith and I am an experienced <strong>lead agile business analyst</strong> working at <a href="http://which.co.uk" rel="nofollow">Which?</a>.  	
>>>>>>> origin/master
			</p>
			<h4>About?</h4>
			<p>I have a particular interest in <strong>web e-commerce &amp; technologies</strong> and iterative development.  Recently I have been successfully using a BDD approach within a cross functional SCRUM team for projects within Which?. </p>
			<h4>Where?</h4>
